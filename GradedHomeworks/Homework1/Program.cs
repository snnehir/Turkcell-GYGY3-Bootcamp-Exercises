/*
 About Graded Homework:
    - Design a School Management System.
    - Entities: Classroom, Student, Teacher, Homework... etc.
    - School has multiple classrooms.
    - Each classroom has one responsible teacher. (1 to 1 relation between Classroom and Teacher)
    - Each classroom can have multiple students.  (1 to M relation between Classroom and Student)
    - Teacher can assign homework to students and student can submit their homework.
    - System should be designed considering OOP and SOLID principles.
...
/*
 TODO: 
    - Homework operations.
    - Implement cascade remove when a classroom is removed.
    - Fix update operations.
    - Fix menu, constant messages.
